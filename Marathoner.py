...
# WINDOW SETTINGS
screen_size = (int(info.current_w / 1.5), int(info.current_h / 1.5))
...
while True:
    ...
    if current_screen == 0:
        ...
        if score == 0:
            ...
            game_message = game_font.render(f"YOUR SCORE: {score}", False, "White")
        ...
        game_message_rect = game_message.get_rect(center=(screen_size[0] // 2, screen_size[1] // 1.25))
    ...
    # GAME
        ...
        esc_message_rect = esc_message.get_rect(center=(screen_size[0] - screen_size[0] // 12, screen_size[1] // 14))
